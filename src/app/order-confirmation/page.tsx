      ...
      <div className="relative py-16">
        ...
        <div className="absolute top-1/2 left-12 transform -translate-y-1/2 flex flex-col items-center">
          <div className="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center">
            <Image src="/clock 1.png" alt="Clock Icon" height={8}  width={8}  />
          </div>
        </div>
        ...
        <div className="absolute left-1/2 top-30 transform -translate-x-1/2 -translate-y-1/2">
          <div className="w-20 h-20 bg-white rounded-full flex items-center justify-center shadow-md">
            <Image src="/Vector 15.png" alt="Check Icon" height={10}  width={10}  />
          </div>
        </div>
        ...
        <div className="absolute bottom-12 right-12 flex flex-col items-center">
          <div className="w-16 h-16 bg-pink-100 rounded-full flex items-center justify-center">
            <Image src="/checklist 1.png" alt="Clipboard Icon" height={8} width={8}  />
          </div>
        </div>
