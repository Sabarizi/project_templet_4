  ...
  const products = [
    {
      ...
      image: "/cart1.png", // Leading slash added
      color: "Brown",
      size: "XL",
      price: 32.0,
      quantity: 1,
    },
    {
      id: 2,
      name: "Black Handbag",
      image: "/cart2.png", // Leading slash added
      color: "Black",
      size: "M",
      price: 45.0,
      quantity: 2,
    },
    {
      ...
      image: "/cart3.png", // Leading slash added
      color: "Red",
      size: "L",
      price: 25.0,
      quantity: 1,
    },
    {
      id: 4,
      name: "Gray Tote Bag",
      image: "/cart4.png", // Leading slash added
      color: "Gray",
      size: "XL",
      price: 38.0,
      quantity: 3,
    },
    {
      id: 5,
      name: "Pink Mini Bag",
      image: "/cart5.png", // Leading slash added
      color: "Pink",
      size: "S",
      price: 29.0,
      quantity: 1,
