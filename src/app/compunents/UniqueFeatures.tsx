...
const UniqueFeatures = () => {
  // Match the interface by using "id" instead of "_id"
  // and use the correct type (string vs number) that AddToCartButton expects.
  const product = {
    _id: "1", // if your AddToCartButton expects a string
